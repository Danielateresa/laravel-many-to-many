                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr class="table-primary">
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="deleteProject-" tabindex="-1" data-bs-backdrop="static"
                                    data-bs-keyboard="false" role="dialog" aria-labelledby="modalProjectId-"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                        role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalProjectId-">Delete
                                                    Project</h5>
